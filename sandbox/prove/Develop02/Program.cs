...
{   private static List<Entry> entries = new List<Entry>();
    static void Main(string[] args)
    {
        ...
        Weather todayWeather = new Weather("New York", DateTime.Now, 20.0);
        ...
        while (userNumber != 5)
        {
            if (userNumber == 1)
            {
                ...
                Console.WriteLine($"Today's Weather in {todayWeather.Location} on {todayWeather.Date.ToShortDateString()}:");
